...
public class PBKDF2Utils {
	 ...
	 * 生成密文的长度
	 */
	public static final int HASH_BIT_SIZE = 128;// 128 * 4;

	/**
	 * 迭代次数
	 */
	public static final int PBKDF2_ITERATIONS = 100;// 1000;
	...
	public static void main(String[] args) {
		...
		try {
			...
			salt = generateSalt();
			salt = "5774303f9a36355879e94cbba6e05503";
			password = "d6ba777768a625e3f180b6e920ba3208";
			...
			System.out.println("9cb310b4cadef707fbcde199a1b983e2");
